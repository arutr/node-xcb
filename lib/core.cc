...
Napi::Object Core::CreateVoidCookie(const Napi::CallbackInfo& info, const xcb_void_cookie_t* void_cookie)
{
	auto env = info.Env();
	auto object = Napi::Object::New(env);
	object["sequence"] = Napi::Number::New(env, void_cookie->sequence);
